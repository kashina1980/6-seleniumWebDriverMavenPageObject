...
public class MantisSite {
    ...
    private ViewIssuesDetailsPage viewIssuesDetailsPage;
    ...
    public MantisSite(WebDriver driver) {
        ...
        viewIssuesDetailsPage = new ViewIssuesDetailsPage(driver);
    }
    ...
    public ViewIssuesDetailsPage getViewIssuesDetailsPage() {
        return viewIssuesDetailsPage;
    }
}
